...
## Просмотр всех веток 
Для того чтобы посмотреть все созданные ветки нужно в терминале задать команду:
   * git branch 
...
Для перехода с ветки на ветку задается команда:
   * git checkout <имя ветки на которую переходим>
   
## Слияние ветки
Для того чтобы слить информацию с ветки на ветку мастер надо задать команду:
...
## Работа с удаленным пепозиторием
